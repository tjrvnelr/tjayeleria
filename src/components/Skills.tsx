...
import {
  ...
  SiPostgresql, SiDocker, SiGit, SiPython, SiFigma, SiVercel,
  SiGraphql, SiMongodb, SiRedis, SiKubernetes, SiJavascript,
} from 'react-icons/si';
...
function SkillCard({ icon: Icon, label, level, color, delay }: {
  icon: React.ComponentType<{ size?: number; style?: React.CSSProperties }>;
  label: string; level: number; color: string; delay: number;
}) {
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-28 bg-[#112D4E] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        >
          <span className="text-[#3F72AF] text-sm font-semibold uppercase tracking-widest">Tech Stack</span>
          ...
          <p className="mt-5 text-[#F9F7F7]/50 max-w-xl mx-auto text-base">
            A curated set of tools and technologies I use to build world-class products.
          </p>
        </motion.div>
