...
const contactInfo = [
  {
    icon: FiMail,
    label: "Email",
    value: "tjayeleria9@gmail.com",
    href: "mailto:tjayeleria9@gmail.com",
  },
  {
    icon: FiPhone,
    label: "Phone",
    value: "+63 966 167 3231",
    href: "tel:+639661673231",
  },
  { icon: FiMapPin, label: "Location", value: "San Fabian, Philippines", href: null },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            <div>
              <h3 className="text-[#F9F7F7] font-semibold text-xl mb-2">
                Contact Information
              </h3>
              <p className="text-[#F9F7F7]/40 text-sm leading-relaxed">
                Open to freelance opportunities, full-time roles, and
            ...
            <div className="space-y-4">
              {contactInfo.map(({ icon: Icon, label, value, href }) => (
                <div
                  key={label}
                  className="flex items-start gap-4 p-4 rounded-xl bg-[#F9F7F7]/5 border border-[#F9F7F7]/8 hover:border-[#3F72AF]/30 transition-all duration-300 group"
                >
                  ...
                  <div>
                    <div className="text-[#F9F7F7]/30 text-xs mb-0.5">
                      {label}
                    </div>
                    {href ? (
                      <a
                        href={href}
                        className="text-[#F9F7F7]/70 text-sm hover:text-[#3F72AF] transition-colors duration-200"
                      >
                        {value}
                      </a>
                    ) : (
            ...
            <div className="p-5 rounded-xl bg-[#3F72AF]/10 border border-[#3F72AF]/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[#F9F7F7]/70 text-sm font-medium">
                  Available for work
                </span>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                whileHover={
                  !submitting && !submitted ? { scale: 1.02, y: -1 } : {}
                }
